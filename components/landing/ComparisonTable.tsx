...
const ROWS = [
  {
    ...
    ours: "Personalized to what you actually marked on exam day",
  },
  {
    coaching: "Treats every student the same",
    ours: "Identifies the 15% that's actually missing for YOU",
  },
  {
    coaching: "Covers topics you already know",
    ours: "Skips your strengths, attacks your weaknesses",
  },
  {
    coaching: "Panic + overwhelm + drop-off by Day 3",
    ours: "Calm, targeted confidence — day-by-day clarity",
  },
  {
